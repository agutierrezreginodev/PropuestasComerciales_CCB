...
| ID | Tarea | Flujo · nodo | Esf. | Cómo se verifica | Hecho |
|---|---|---|---|---|---|
| F2-01 | Insertar un nodo de validación inmediatamente después del trigger, con rama de rechazo | los 12 activos | ▪▪▪ | Un payload sin campos requeridos se rechaza **antes** de leer o escribir en Data Table | ☐ *(hecho parcialmente: 6 de 12 — W4D vía F2-04, W2C, W4C, W1 vía F2-07, y ahora W5A y W5B; resto pendiente — ver nota)* |
...
>
> Quedan 6 de 12 flujos activos sin este gatekeeping — extenderlo queda para la próxima ronda de esta fase.
