...
| ID | Tarea | Flujo · nodo | Esf. | Cómo se verifica | Hecho |
|---|---|---|---|---|---|
| F2-01 | Insertar un nodo de validación inmediatamente después del trigger, con rama de rechazo | los 12 activos | ▪▪▪ | Un payload sin campos requeridos se rechaza **antes** de leer o escribir en Data Table | ☐ *(hecho parcialmente: 10 de 12 — W4D vía F2-04, W2C, W4C, W1 vía F2-07, W5A, W5B, W4A, W4B, y ahora W2A y W3; resto pendiente — ver nota)* |
...
>
> Quedan 2 de 12 flujos activos sin este gatekeeping — extenderlo queda para la próxima ronda de esta fase.
